...
func MultiplyIntHandler(logger *slog.Logger) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		var req models.MultiplyRequestInt
...
func MultiplyFloatHandler(logger *slog.Logger) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != "POST" {
			respond.WriteError(logger, w, http.StatusMethodNotAllowed, "only POST allowed")
			return
